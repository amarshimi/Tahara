 ...
 * holidays)</li>
 * <li>Getting the regular parsha (Torah or sedra) reading for Shabbos</li>
 * <li>Getting the current Omer count</li>
 * </ul>
...
public class RegularHebrewDate extends HebrewDate {
    ...
    private static final String[][] parshios = { { "Bereshit", "Bereshis" },
    ...
    /**
     * Initializes based on a month, date, year and whether it is ashkenaz
     * pronunciation or whether it is Israel parsha scheme.
     */
    public RegularHebrewDate(int m, int d, int y, boolean ashkenaz,
                             boolean israeli) {
        super(m, d, y);
    ...
    public RegularHebrewDate(int m, int d, int y) {
        super(m, d, y);
    }
    ...
    /**
     * returns a String of the holiday or fast day for the current day, or an
     * empty string if there is no holiday for this day. Has no "modern"
     * holidays.
     *
    ...
    public String getHoliday() {
        ...
        switch (hebrewMonth) {
            case 1:
                if (hebrewDate == 14) {
                    return "ערב פסח";
                } else if (hebrewDate == 15 || hebrewDate == 21
                        || (israeli && (hebrewDate == 16 || hebrewDate == 22))) {
                    return "פסח";
                } else if (hebrewDate >= 17 && hebrewDate <= 20
                        || (hebrewDate == 16 && !israeli)) {
            ...
            case 3:
                ...
                } else if (hebrewDate == 6 || (hebrewDate == 7 && !israeli)) {
                    if (ashkenaz) {
                        return "Shavuos";
                    } else {
                        return "Shavuot";
            ...
            case 7:
                ...
                } else if ((hebrewDate == 3 && day != 7)
                        || (hebrewDate == 4 && day == 1)) { // push off tzom gedalia
                    // if it falls on
                    // Shabbos
                    return "Tzom Gedalia";
                } else if (hebrewDate == 9) {
                    return "Erev Yom Kippur";
                } else if (hebrewDate == 10) {
                    return "Yom Kippur";
                } else if (hebrewDate == 14) {
                    if (ashkenaz) {
                        return "Erev Sukkos";
                    } else {
                        return "Erev Sukkot";
            ...
            case 9:
                ...
                } else if (hebrewDate >= 25) {
                    return "�����";
                }
                break;
            case 10:
                if (hebrewDate == 1 || hebrewDate == 2
                        || (hebrewDate == 3 && isKislevShort())) {
                    return "�����";
                } else if (hebrewDate == 10) {
                    if (ashkenaz) {
                        return "10 ����";
     ...
     */
    public int getOmer() {
        int omer = 0; // int omer = Integer.MIN_VALUE;
        ...
        } else if (hebrewMonth == 3 && hebrewDate < 6)
            omer = hebrewDate + 44;
    ...
    //FIXME - Add real implementation (look at GeoLocation) - do not swallow IllegalArgumentException
    //(that should never happen anyways if cloning a real object)
    public Object clone() {
//		try {
